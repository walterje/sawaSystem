...
from Aplicaciones.User.forms import *
...
class UserDeleteView(LoginRequiredMixin, ValidatePermissionRequiredMixin,DeleteView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        try:
            ...
            data['error'] = 'Este usuario  no se puede eliminar tiene una transaccion realizada'
        return JsonResponse(data)
...
class UserProfileView(LoginRequiredMixin,ValidatePermissionRequiredMixin, UpdateView):
    model = User
