...
import SAWA_SYS.settings as setting
from SAWA_SYS import settings
from Aplicaciones.Login.forms import ResetPasswordForm, ChangePasswordForm
...
class ChangePasswordView(FormView):
    ...
    def get_context_data(self, **kwargs):
        context = super().get_context_data(**kwargs)
        context['title'] = 'Reseteo de Contraseña'
        context['login_url'] = settings.LOGIN_REDIRECT_URL
        return context
